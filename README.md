...
Исходный код опубликован для ознакомления. Все права защищены — см. [LICENSE.md](LICENSE.md). Перед переводом проекта на открытую лицензию замените этот файл на MIT, Apache-2.0 или другую выбранную лицензию.
